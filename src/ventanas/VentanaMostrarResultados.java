...
public class VentanaMostrarResultados extends javax.swing.JDialog {
    ...
    private int veces1, veces2, vecesEmp;
    
    
    public VentanaMostrarResultados(java.awt.Frame parent, boolean modal, String usuario1, String usuario2, int veces1, int veces2, int vecesEmp) {
        super(parent, modal);
    ...
    private void cargarDatosTabla() {
        ...
        String [] fila = {String.valueOf(veces1), String.valueOf(veces2), String.valueOf(vecesEmp)};
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 52, 450, 100));
